        ...
        <nav>
          <div className="nav__container">
            ...
            <ul className="nav__links">
              ...
              <li>
                <a href="http://127.0.0.1:5500/books.html" className="nav__link nav__link--primary">
                  Books
                </a>
              </li>
            </ul>
          ...
          {menuOpen && (
            <div className="menu__backdrop">
              ...
              <ul className="menu__links">
                ...
                <li className="menu__list">
                  <a className="menu__link no-cursor" href="#" onClick={closeMenu}>Contact</a>
                  </li>
              </ul>
            </div>
          )}
      ...
      <footer>
        <div className="container">
          <div className="row footer__row">
            <a href="#">
              <img className="footer__logo" src={LibrarySvg} alt="Library Logo" />
            </a>
